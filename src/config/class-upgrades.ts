...
const ARCHER_DRIVKRAFT: ClassUpgradeConfig[] = [
    {
        ...
        isAbilityUpgrade: true,
        summary: 'Øker eksplosjonsradius for Explosive Shot',
        value: { suffix: 'px', getValue: (lvl) => 120 + lvl * 40 },
        maxLevel: 3,
        basePrice: 220,
        priceScale: 2.3,
    ...
    },
    {
        ...
        shopCategoryId: 'archer_drivkraft',
        isAbilityUpgrade: true,
        summary: 'Øker skademultiplikator for Explosive Shot',
        value: { suffix: 'x skade', getValue: (lvl) => (2.0 + lvl * 0.3).toFixed(1) },
        maxLevel: 3,
        basePrice: 250,
        priceScale: 2.5,
        iconTint: 'drop-shadow(0 0 5px #ff6600) hue-rotate(20deg)',
    ...
    },
    {
        ...
        shopCategoryId: 'archer_drivkraft',
        isAbilityUpgrade: true,
        summary: 'Eksplosive skudd genererer ekstra piler',
        value: { suffix: ' piler', getValue: (lvl) => lvl === 1 ? 2 : 3 },
        maxLevel: 2,
        basePrice: 550,
        priceScale: 3.0,
        iconTint: 'drop-shadow(0 0 5px #ff6600) hue-rotate(20deg)',
